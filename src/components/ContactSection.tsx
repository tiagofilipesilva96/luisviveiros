        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <motion.a
              ...
              className="btn-press group flex flex-col items-center text-center p-8 rounded-3xl transition-all duration-300"
              style={card.dark ? {
