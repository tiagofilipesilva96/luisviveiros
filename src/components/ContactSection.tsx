      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Estou disponível para o ajudar. Escolha a forma de contacto mais conveniente para si.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {cards.map((card, i) => (
            <motion.a
              ...
              className="group flex flex-col items-center text-center p-8 rounded-3xl transition-shadow duration-500 hover:shadow-[0_16px_48px_rgba(0,0,0,0.09)]"
              style={card.dark ? {
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground">Fale comigo hoje e descubra como posso ajudá-lo a encontrar o imóvel perfeito.</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <a
              ...
              style={{ background: "linear-gradient(135deg, oklch(0.88 0.09 85), oklch(0.72 0.13 80))", boxShadow: "0 4px 16px rgba(180,140,60,0.25)" }}
            >
